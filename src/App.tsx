...
<div className="incident-actions">
  ...
  {incidentAnalysis && (
    ...
    >
      {isResponsePlanLoading ? 'Planning...' : 'Generate response plan'}
    </button>
  )}
</div>
{incidentAnalysis && (
...
{responsePlan && (
  <div className="response-plan" aria-live="polite">
    ...
    <small>AI-generated from the selected incident and its analysis.</small>
  </div>
)}
</aside></div></section>
